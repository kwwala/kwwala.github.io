          ...
          {SOCIAL_LINKS.map(({ href, icon: Icon, label }) => (
            ...
            >
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="link-padding link-underline-parent flex cursor-pointer items-center gap-3 text-sm text-zinc-200 transition-colors delay-50 duration-200 ease-[cubic-bezier(.1,0,0,1)] group-hover:delay-0 group-hover:ease-[cubic-bezier(.1,0,0,1)] group-hover:text-[#3c9]"
              >
                ...
                <span className="link-underline">{label.toLowerCase()}</span>
              </a>
            </li>
          ))}
        </ul>
